...
Protected Module ImagePlayEffectsLibrary
	...
	#tag Method, Flags = &h1
		Protected Sub ColorPalette(pic as picture, Colors() as color)
		  ...
		  R=NewMemoryBlock(u+1)
		  G=NewMemoryBlock(u+1)
		  B=NewMemoryBlock(u+1)
		  for i=0 to u
		    c=Colors(i)
		    R.Byte(i)=c.red
		    G.Byte(i)=c.green
	...
	#tag Method, Flags = &h1
		Protected Function Utility_ColorArrayToString(Colors() as color) As String
		  // by Tomis Erwin
	...
	#tag Method, Flags = &h1
		Protected Function Utility_ColorArrayToString(ParamArray Colors as color) As String
		  // by Tomis Erwin
		  // convert an array of colors into a string list
		  // output: "FF0000,4423Ad,093B50"
